...
//! FIXME: how to import burger so i don't need to paste it here
...
const Nav = () => {
    ...
    return (
        <>
            <AnimatePresence>
                {burgerOpen && (
                    <Burger handleBurgerClose={handleBurgerClose}></Burger>
                )}
            </AnimatePresence>
            ...
            <nav className={styles.nav}>
                ...
                <div className={styles.right}>
                    ...
                    {/* //! SEARCH */}
                    <div onClick={handleSearchOpen} className={styles.searchContainer}>
                        <AnimatePresence>
                            {searchOpen && (
                                <Search></Search>
                            )}
                    ...
                    {/* //! CART */}
                    <NavLink to='cart' className={({ isActive }) => isActive ? `${styles.iconActive}` : ''}>
                        <svg
                            width="24"
                            height="24"
                            viewBox="0 0 24 24"
                    ...
                    {/* //! PROFILE */}
                    <NavLink to='profile' className={({ isActive }) => isActive ? `${styles.iconActive}` : ''}>
                        <svg
                            width="24"
                            height="24"
                            viewBox="0 0 24 24"
