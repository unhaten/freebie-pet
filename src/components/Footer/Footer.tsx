        ...
        <footer className={styles.footer}>
            ...
            <ul className={styles.payment}>
                <li className={styles.paymentIcon}>
                    <img src={badge1} alt="paymentIcon" className={styles.iconImg} />
                </li>
                <li className={styles.paymentIcon}>
                    <img src={badge2} alt="paymentIcon" className={styles.iconImg} />
                </li>
                <li className={styles.paymentIcon}>
                    <img src={badge3} alt="paymentIcon" className={styles.iconImg} />
                </li>
                <li className={styles.paymentIcon}>
                    <img src={badge4} alt="paymentIcon" className={styles.iconImg} />
                </li>
                <li className={styles.paymentIcon}>
                    <img src={badge5} alt="paymentIcon" className={styles.iconImg} />
                </li>
            </ul>
        </footer>
    );
